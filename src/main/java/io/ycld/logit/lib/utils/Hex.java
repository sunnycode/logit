...
public class Hex {
  ...
  /**
   * Converts an array of characters representing hexidecimal values into an array of bytes of those
  ...
  /**
   * Converts an array of character bytes representing hexidecimal values into an array of bytes of
  ...
  /**
   * Converts a String or an array of character bytes representing hexidecimal values into an array
   ...
   * hexidecimal values of each byte in order. The returned array will be double the length of the
  ...
  /**
   * Converts a String or an array of bytes into an array of characters representing the hexidecimal
