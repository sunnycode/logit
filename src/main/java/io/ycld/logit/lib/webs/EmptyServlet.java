...
/**
 * An Empty, "do nothing servlet" that never gets called. But, it's necessary to register at least
 * one servlet - otherwise, the guice and jersey filters will never kick in. Nothing to see here...
 */
